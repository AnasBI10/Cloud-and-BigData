...
## Cluster-Neuaufbau (08.09.2026)
Nach einem Netzwerk-Vorfall auf der ursprünglichen Single-Node-Instanz
(Interface-Konfiguration ging bei einer Netzwerk-Migration verloren) wurde
das Cluster komplett neu aufgesetzt - diesmal als echtes 3-Node-Setup
(Master 80GB, 2 Worker je 50GB Disk). Alle Komponenten (Kafka, MinIO,
